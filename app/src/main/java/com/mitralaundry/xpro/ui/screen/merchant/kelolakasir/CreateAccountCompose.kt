...
@Composable
    fun AddAccountCompose(viewModel: ViewModelUser, outletId : String, context: Context, navHostController : NavHostController) {
        ...
        Scaffold(
            ...
            Column(
                ...
                Button(
                    ...
                    onClick = {
                        viewModel.addUser(outletId,context)
                    }) {
                    Text(text = "Simpan")
                }
...
@Composable
private fun dialogSucces(viewModel: ViewModelUser){
    val status by viewModel.statusAdd.observeAsState(Status.NONE)
